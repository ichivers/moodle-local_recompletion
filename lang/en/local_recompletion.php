...
$string['recompletionbadgeenable'] = 'Remove badge on recompletion';
$string['recompletionunenrolenable_help'] = 'Enable to trigger completion reset on user un-enrolment';
$string['recompletionbadgeenable_help'] = 'Enable to remove badges on recompletion.  Badge will be removed from the user\'s profile at recompletion.';
